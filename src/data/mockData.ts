...
// ==========================================
// 1. USD DATASET (Figma-Matched visual states)
// ==========================================

export const MOCK_CAPITAL_GAINS_USD: SummaryGains = {
  stcg: {
    profits: 1540,
    losses: 743,
    netGains: 797,
...
export const MOCK_HOLDINGS_USD: Holding[] = [
  ...
  },
  {
    ...
    totalHolding: 5.6736,
    averageBuyPrice: 1902.15,
    currentPrice: 1620.15,
    stcg: { balance: 2.332, gain: 55320.15 }, // visually matches figma
    ltcg: { balance: 3.245, gain: 8239.29 },  // visually matches figma
    shortTermQtyText: '2.332 ETH',
    longTermQtyText: '3.245 ETH',
  },
  {
    id: 'usd-3',
    coin: 'USDT',
    ...
    averageBuyPrice: 1.015,
    currentPrice: 1.00,
    stcg: { balance: 2011.23, gain: -1200 },
    ltcg: { balance: 902.47, gain: 2400 },
    shortTermQtyText: '2,011.23 USDT',
    longTermQtyText: '902.47 USDT',
  },
  {
    id: 'usd-4',
    coin: 'MATIC',
    ...
    totalHolding: 2210,
    averageBuyPrice: 2.11,
    currentPrice: 2.31,
    stcg: { balance: 802, gain: -1200 },
    ltcg: { balance: 1402, gain: 2400 },
    shortTermQtyText: '802 MATIC',
    longTermQtyText: '1,402 MATIC',
  },
  {
    id: 'usd-5',
    coin: 'ETH',
...
// ==========================================
// 2. INR DATASET (Official Assignment JSON details)
// ==========================================

export const MOCK_CAPITAL_GAINS_INR: SummaryGains = {
  stcg: {
    profits: 70200.88,
    losses: 1548.53,
    netGains: 68652.35, // 70200.88 - 1548.53
  },
  ltcg: {
    profits: 5020.00,
    losses: 3050.00,
    netGains: 1970.00, // 5020 - 3050
  },
  realised: 70622.35, // 68652.35 + 1970
};

export const MOCK_HOLDINGS_INR: Holding[] = [
  {
    id: 'inr-1',
    coin: 'USDC',
    coinName: 'USDC',
  ...
  },
  {
    ...
    stcg: { balance: 1.3172764293128694, gain: -49.954151016387065 }, // simulated negative as a TLH candidate!
    ltcg: { balance: 1, gain: -20 } // simulated negative as a TLH candidate!
  },
  {
    id: 'inr-5',
    coin: 'MATIC',
    ...
    stcg: { balance: 2.75145540184285, gain: -59.244262152615974 }, // simulated negative as a TLH candidate!
    ltcg: { balance: 0, gain: 0 }
  },
  {
    id: 'inr-6',
  ...
  },
  {
    ...
    stcg: { balance: 0.0004211938732637162, gain: -89.40775336229291 }, // simulated negative ST loss candidate!
    ltcg: { balance: 0, gain: 0 }
  },
  {
    id: 'inr-15',
  ...
  },
  {
    ...
    stcg: { balance: 0.04265758808550148, gain: -2.1877356683780986 }, // simulated ST loss candidate!
    ltcg: { balance: 0, gain: 0 }
  },
  {
    id: 'inr-23',
